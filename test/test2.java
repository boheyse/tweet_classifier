...
public class test2 {
  /**
    Constructs a ClassifyTweetsobjects that saves the locations of the files
  */
  //public test
  public static void main(String[] args) throws Exception {
    ...
    scan = new Scanner(new BufferedReader(new FileReader("t.csv")));
